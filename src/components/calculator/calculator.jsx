    ...
    <section className="calculator">
      ...
      <form className="calculator__form">
        <fieldset className="steps">
          ...
          <label className="steps__select-tittle" htmlFor="steps-select" aria-label="выберите тип кредитования">
        ...
        <fieldset className="steps">
          ...
          <div className="steps__user-data-wrapper">
            <label className="steps__user-data-description" htmlFor="name">
